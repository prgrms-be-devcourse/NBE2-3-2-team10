...
<head>
    ...
    <script>
        ...
        function changeSvg() {
            ...
            const homeArray = ["/customer/main", "/customer/laundryshop-by-map", "/customer/laundryshop-by-category"];
            const orderArray = ["/customer/orderHistory"];
            const starArray = ["/customer/mypage", "/customer/myInfo", "/customer/myInfoModify"];
