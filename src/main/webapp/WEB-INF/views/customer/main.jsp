...
<main class="p-3 space-y-4 max-w-[448px] overflow-x-auto mx-auto bg-gray-100">
    ...
    <div class="flex space-x-4">
        <button class="flex-1 bg-[#4AC7D5] text-white py-2 rounded-lg shadow" onclick="window.location.href='/customer/laundryshop-by-map'">내 주변 세탁소 찾기</button>
    ...
    <div class="border border-[#E1D9D9] p-1 h-[201px] bg-[#FFFFFF] rounded-lg shadow-md text-[10pt]">
        <div class="mt-2 grid grid-cols-4 ">
            <div class="flex flex-col items-center" onclick="window.location.href='/customer/laundryshop-by-category/SHOES'">
                <img src = "./main/category/shoes.svg" class = "h-[54px] w-[63px]"/>
                <div class="mt-2">신발</div>
            </div>
            <div class="flex flex-col items-center" onclick="window.location.href='/customer/laundryshop-by-category/PADDING'">
                <img src = "./main/category/padding.svg" class = "h-[54px] w-[63px]"/>
                <div class="mt-2">패딩</div>
            </div>
            <div class="flex flex-col items-center" onclick="window.location.href='/customer/laundryshop-by-category/PREMIUM_FABRIC'">
        ...
        <div class="mt-2 grid grid-cols-4">
            <div class="flex flex-col items-center" onclick="window.location.href='/customer/laundryshop-by-category/COTTON_LAUNDRY'">
                <img src = "./main/category/cotton-laundry.svg" class = "h-[54px] w-[63px]"/>
                <div class="mt-2">면 세탁물</div>
            </div>
            <div class="flex flex-col items-center" onclick="window.location.href='/customer/laundryshop-by-category/STORAGE_SERVICE'">
                <img src = "./main/category/bedstorage-service.svg" class = "h-[54px] w-[63px]"/>
                <div class="mt-2">보관 서비스</div>
            </div>
            <div class="flex flex-col items-center" onclick="window.location.href='/customer/laundryshop-by-category/BEDDING'">
