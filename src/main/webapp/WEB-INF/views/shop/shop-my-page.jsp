...
<div class="max-w-md mx-auto bg-white shadow-md rounded-lg mt-0 ">
    ...
    <div class="flex justify-around mt-4">
        <button class="text-center focus:outline-none flex flex-col justify-center items-center">
            ...
            <a href="/shop/sales-summary" class="text-sm mt-1">워시팡 내역</a>
        </button>
        <button class="text-center focus:outline-none flex flex-col justify-center items-center" onclick="location.href='/shop/myInfo'">
    ...
    <div class="mt-4 border-t">
        ...
        <button class="flex justify-between items-center p-4 border-b w-full focus:outline-none" onclick="location.href='/shop/modify-shop-info'">
            <div>세탁소 등록</div>
            <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
