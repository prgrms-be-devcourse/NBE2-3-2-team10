...
<footer class="fixed bottom-0 left-0 right-0 bg-white shadow p-4 flex justify-around overflow-x-auto mx-auto max-w-[448px] rounded-t-lg">
    ...
    <script>
        ...
        function changeSvg() {
            ...
            const homeArray = ["/shop/shop-main", "/shop/pickup-check", "/shop/pickup-delivery" ];
            const starArray = ["/shop/shop/mypage", "/shop/shop/myInfoModify", "/shop/shop/myInfo", "/shop/shop/mypage"];
